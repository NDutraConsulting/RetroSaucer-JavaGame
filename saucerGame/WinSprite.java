...
public class WinSprite implements Sprite
{
  
    private Rectangle displayBounds;
    
   // private BufferedImage winBMP;
    ...
    public WinSprite( )
    {
        ...
        try
        {
            ...
            splashBMP = ImageUtil.loadBufferedImage( this, "images/valcaanobg1.png" );
    ...
    public void draw( Graphics2D g )
    {
        ...
        g.drawString( "You Win ", (displayBounds.width/2), (displayBounds.height/2) );
        g.setFont( f );
        g.setColor( Color.WHITE );
        g.drawString( "S to reStart ", (displayBounds.width/2), ((displayBounds.height/2) + 50) );
