...
public class GameDisplay
{
    ...
    /**
     * Capture the mouse cursor so that it does not leave the display frame. Holding the shift key will allow the cursor to escape.
     * 
     * @param value
     */
    ...
    public static void create( int width, int height )
    {
        if ( frameInstance == null )
        {
            ...
            frameInstance.addMouseMotionListener( new MouseMotionAdapter()
            {
                ...
                {
                    /**
                     * If the mouse is dragged (moved with a button pressed) outside the frame, move it back
                     */
    ...
    public static void setFullScreen()
    {
        if ( frameInstance != null )
        {
            ...
            /**
             * If full screen is supported then switch to full screen mode and find the best display mode that matches the frame
             * instance
             */
    ...
    /**
     * Process the mouse event to keep the mouse movement within the game display. Allow the mouse to escape the frame when the shift
     * key is held down.
     * 
     * @param me
     * @return
    ...
    {
        /**
         * If the mouse has left the building then force the mouse back onto the frame. Since the mouse has left make sure to adjust the
